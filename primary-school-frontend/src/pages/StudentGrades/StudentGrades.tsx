...
// Об'єкт для зберігання аудіофайлів
...
const StudentGrades = () => {
    ...
    const playAudio = (key: string) => {
        // Використовуємо відповідний аудіофайл або запасний варіант, якщо файл не знайдено
        const audioSrc = audioFiles[key.toLowerCase()] || audioFiles['default'];
